/**
 * OctoC2 — Proto definition inlined as a string constant.
 *
 * BeaconGrpcClient writes this to a temp file so @grpc/proto-loader can
 * load it (proto-loader requires a file path, not a string). The temp file
